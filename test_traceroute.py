...
wifi_traceroute_google = np.loadtxt('traceroute_wifi_google.txt',delimiter=' ',dtype=float)
lte_traceroute_google = np.loadtxt('traceroute_lte_google.txt',delimiter=' ',dtype=float)
...
# wifi_traceroute_g5 = np.loadtxt('traceroute_wifi_g5.txt',delimiter=' ',dtype=float)
# lte_traceroute_g5 = np.loadtxt('traceroute_lte_g5.txt',delimiter=' ',dtype=float)
...
plt.title('WiFi vs LTE Traceroute (www.google.com)')

# plt.xlim(1,20)
# plt.ylim(0,450)
# plt.xticks(np.arange(1,21,step=1))
# plt.title('WiFi vs LTE Traceroute (www.g5web.com)')
plt.show()
