...
wifi_bloated = np.loadtxt('wifi_bloated_google.txt',delimiter=' ',dtype=float)
wifi_clean = np.loadtxt('wifi_clean_google.txt',delimiter=' ',dtype=float)
# lte_bloated = np.loadtxt('lte_bloated_google.txt',delimiter=' ',dtype=float)
# lte_clean = np.loadtxt('lte_clean_google.txt',delimiter=' ',dtype=float)
...
plt.title('WiFi Results (www.google.com)')
# plt.title('LTE Results (www.google.com)')
# plt.title('WiFi vs LTE Results (www.google.com)')
plt.show()
